...
def Receipt(pdlist,cash=500):
	...
	textlines = ['บริษัท แมคคา จำกัด',
				 'ที่อยู่ 294/18 ม.สิริพาร์ค ซ.วงสว่่าง11'
                                 ,'แขวงวงศ์สว่าง เขต บางซื่อ กทม. 10800',
				 'เบอร์โทร 086-947-6682',
				 'TAX ID: 1212312121']
	...
	for i,line in enumerate(textlines):
		c.drawCentredString(29 * mm,(47 + (i*2.5)  + diff) * mm,line)

	#######TS ID##########

	c.setFont('F2',6)
	c.drawString(10 * mm, (42  + diff) * mm,'TS: POS12123')

	c.drawString(8 * mm, (35  + diff) * mm,'Product')
	c.drawString(28 * mm, (35  + diff) * mm,'Quantity')
	c.drawString(45 * mm, (35  + diff) * mm,'Price')
